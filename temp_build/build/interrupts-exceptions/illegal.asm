...
build/interrupts-exceptions/illegal:     file format elf32-littleriscv
...
8000004a:	95618193          	add	gp,gp,-1706 # 8000099c <__bss_end>
...
80000064:	de618413          	add	s0,gp,-538 # 80000782 <__init_array_end>
80000068:	de618493          	add	s1,gp,-538 # 80000782 <__init_array_end>
...
8000007e:	de618413          	add	s0,gp,-538 # 80000782 <__init_array_end>
80000082:	de618493          	add	s1,gp,-538 # 80000782 <__init_array_end>
...
8000009c <done>:
8000009c:	de818d93          	add	s11,gp,-536 # 80000784 <flag>
800000a0:	000dae03          	lw	t3,0(s11)
800000a4:	dec18d93          	add	s11,gp,-532 # 80000788 <tohost>
...
800000b8:	6dc50513          	add	a0,a0,1756 # 80000790 <fromhost+0x4>
800000bc:	ce3a                	sw	a4,28(sp)
800000be:	cc3e                	sw	a5,24(sp)
800000c0:	de06                	sw	ra,60(sp)
800000c2:	dc16                	sw	t0,56(sp)
800000c4:	da1a                	sw	t1,52(sp)
800000c6:	d81e                	sw	t2,48(sp)
800000c8:	d42e                	sw	a1,40(sp)
800000ca:	d232                	sw	a2,36(sp)
800000cc:	d036                	sw	a3,32(sp)
800000ce:	ca42                	sw	a6,20(sp)
800000d0:	c846                	sw	a7,16(sp)
800000d2:	c672                	sw	t3,12(sp)
800000d4:	c476                	sw	t4,8(sp)
800000d6:	c27a                	sw	t5,4(sp)
800000d8:	c07e                	sw	t6,0(sp)
800000da:	2eed                	jal	800004d4 <print>
800000dc:	4511                	li	a0,4
800000de:	21b1                	jal	8000052a <advance_mepc>
800000e0:	4785                	li	a5,1
800000e2:	def1a423          	sw	a5,-536(gp) # 80000784 <flag>
...
80000128:	ffffffff          	.word	0xffffffff
8000012c:	de81a703          	lw	a4,-536(gp) # 80000784 <flag>
80000130:	4785                	li	a5,1
80000132:	00f70b63          	beq	a4,a5,80000148 <main+0x3a>
80000136:	00000517          	auipc	a0,0x0
8000013a:	6ae50513          	add	a0,a0,1710 # 800007e4 <fromhost+0x58>
...
8000014c:	68050513          	add	a0,a0,1664 # 800007c8 <fromhost+0x3c>
...
80000182:	f9418f13          	add	t5,gp,-108 # 80000930 <fromhost+0x1a4>
...
80000278:	ff018293          	add	t0,gp,-16 # 8000098c <table>
...
800002c6:	ff018293          	add	t0,gp,-16 # 8000098c <table>
...
8000038c:	ff018293          	add	t0,gp,-16 # 8000098c <table>
...
80000418:	ff018293          	add	t0,gp,-16 # 8000098c <table>
...
800005c8:	24050513          	add	a0,a0,576 # 80000804 <fromhost+0x78>
800005cc:	c606                	sw	ra,12(sp)
800005ce:	3719                	jal	800004d4 <print>
800005d0:	57fd                	li	a5,-1
800005d2:	def1a423          	sw	a5,-536(gp) # 80000784 <flag>
...
80000694:	21050513          	add	a0,a0,528 # 800008a0 <fromhost+0x114>
...
800006ca:	1ea50513          	add	a0,a0,490 # 800008b0 <fromhost+0x124>
...
80000700:	1e050513          	add	a0,a0,480 # 800008dc <fromhost+0x150>
...
8000072c:	20450513          	add	a0,a0,516 # 8000092c <fromhost+0x1a0>
80000730:	c606                	sw	ra,12(sp)
80000732:	334d                	jal	800004d4 <print>
80000734:	40b2                	lw	ra,12(sp)
80000736:	de01a423          	sw	zero,-536(gp) # 80000784 <flag>
